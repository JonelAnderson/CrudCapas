...
namespace Domain.Validator
{
    public class UserValidator : AbstractValidator<User>
    {
        public UserValidator()
        {
            ...
            RuleFor(x => x.LastName).MinimumLength(8).WithMessage("El Apellido debe conetner mínimo de 8 caracteres")
            ...
            RuleFor(x => x.Email).MaximumLength(100).WithMessage("El nombre no debe conetner más de 100 caracteres")
                .NotNull().WithMessage("El campo email no puede ser nulo.")
                .NotEmpty().WithMessage("El email es requerido");


            RuleFor(x => x.Phone).MinimumLength(9).WithMessage("El Teléfono debe conetner mínimo de 9 caracteres")
                .MaximumLength(11).WithMessage("El teléfono no debe conetner más de 11 caracteres")
