...
namespace Domain.Validator
{
    public class TreatmentValidator : AbstractValidator<Tratamiento>
    {
        ...
        {
            RuleFor(x => x.Tipo).MinimumLength(4).WithMessage("El Tipo debe contener mínimo de 4 caracteres")
                .MaximumLength(50).WithMessage("El Tipo no debe contener más de 50 caracteres")
            ...
            RuleFor(x => x.Medicamento).MinimumLength(4).WithMessage("El Medicamento debe conetner mínimo de 4 caracteres")
                .MaximumLength(50).WithMessage("El Medicamento no debe contener más de 100 caracteres")
                .NotNull().WithMessage("El campo Medicamento no puede ser nulo.")
                .NotEmpty().WithMessage("El campo Medicamento es requerido.");

            RuleFor(x => x.Descripcion)
                .MaximumLength(255).WithMessage("El nombre no debe contener más de 255 caracteres");
